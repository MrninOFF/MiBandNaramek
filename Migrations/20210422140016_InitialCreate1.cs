        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimestampStart = table.Column<long>(type: "bigint", nullable: false),
                    DateStart = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    TimestampEnd = table.Column<long>(type: "bigint", nullable: false),
                    ...
                    Altitude = table.Column<decimal>(type: "decimal(38,18)", precision: 38, scale: 18, nullable: false),
                    GpxTrack = table.Column<string>(type: "longtext", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ActivityData_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BatteryData_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityData_UserId_TimestampStart",
                table: "ActivityData",
                columns: new[] { "UserId", "TimestampStart" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BatteryData_UserId_Timestamp",
                table: "BatteryData",
                columns: new[] { "UserId", "Timestamp" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MeasuredData_UserId_Timestamp",
                table: "MeasuredData",
                columns: new[] { "UserId", "Timestamp" },
                unique: true);
